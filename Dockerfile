...
RUN cd /home/opam/src && git pull origin master && git checkout 836587f4a26265c064cd9612eff3808075b5cd41
...
RUN opam config exec -- git-delve -d _repos contribs > /home/opam/src/scripts/contribs.txt
